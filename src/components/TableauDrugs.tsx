  ...
  useEffect(() => {
    ...
    const params = [
      ...
      { name: 'site_root', value: '' },
      {
        name: 'name',
        value:
          'incautacion_drogas/AnlisisHistricodeIncautacionesdeDrogasenMedelln',
      },
      { name: 'tabs', value: 'no' },
      { name: 'toolbar', value: 'yes' },
      {
        name: 'static_image',
        value:
          'https://public.tableau.com/static/images/in/incautacion_drogas/AnlisisHistricodeIncautacionesdeDrogasenMedelln/1.png',
      },
