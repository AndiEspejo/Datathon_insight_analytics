...
const TableauPIB = () => {
  ...
  useEffect(() => {
    ...
    const params = [
      ...
      {
        name: 'name',
        value: 'PIBNcional-Antioquia/PIBMilesdeMillonesPesosCorrientes',
      },
      { name: 'tabs', value: 'no' },
      { name: 'toolbar', value: 'yes' },
      {
        name: 'static_image',
        value:
          'https://public.tableau.com/static/images/PI/PIBNcional-Antioquia/PIBMilesdeMillonesPesosCorrientes/1.png',
      },
