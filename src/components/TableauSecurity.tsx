...
const TableauSecurity = () => {
  ...
  useEffect(() => {
    ...
    const params = [
      ...
      {
        name: 'name',
        value: 'Data_Delitos/PanoramadelCrimenenMedelln',
      },
      { name: 'tabs', value: 'no' },
      { name: 'toolbar', value: 'yes' },
      {
        name: 'static_image',
        value:
          'https://public.tableau.com/static/images/Da/Data_Delitos/PanoramadelCrimenenMedelln/1.png',
      },
      ...
      mutations.forEach((mutation) => {
        if (mutation.type === 'childList' && vizElement.children.length > 0) {
          ...
          if (width > 800) {
            ...
            vizElement.style.height = '4077px';
          }
          observer.disconnect();
        }
      });
...
export default TableauSecurity;
