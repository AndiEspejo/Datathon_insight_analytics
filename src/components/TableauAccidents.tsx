...
const TableauAccidents = () => {
  ...
  useEffect(() => {
    ...
    const params = [
      ...
      {
        name: 'name',
        value: 'accidentes_transito/VctimasdeAccidentesdeTrnsitoenMedelln',
      },
      { name: 'tabs', value: 'no' },
      { name: 'toolbar', value: 'yes' },
      {
        name: 'static_image',
        value:
          'https://public.tableau.com/static/images/ac/accidentes_transito/VctimasdeAccidentesdeTrnsitoenMedelln/1.png',
      },
...
export default TableauAccidents;
