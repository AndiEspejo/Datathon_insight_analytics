...
const TableauSocial = () => {
  ...
  useEffect(() => {
    ...
    const params = [
      ...
      {
        name: 'name',
        value: 'indicadores_calidad_vida/IndicadoresSociales',
      },
      { name: 'tabs', value: 'no' },
      { name: 'toolbar', value: 'yes' },
      {
        name: 'static_image',
        value:
          'https://public.tableau.com/static/images/in/indicadores_calidad_vida/IndicadoresSociales/1.png',
      },
      ...
      mutations.forEach((mutation) => {
        if (mutation.type === 'childList' && vizElement.children.length > 0) {
          ...
          if (width > 800) {
            ...
            vizElement.style.height = '7577px';
          }
          observer.disconnect();
        }
      });
